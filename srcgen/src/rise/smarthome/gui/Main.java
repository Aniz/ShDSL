	...
	public static void updateFeaturesTabs(){
		for (FeatureBase feature : house.getFeatures()) {
			if(feature instanceof UserAirConditionerControl){
				...
				if(!alreadyExist){
					UserAirConditionerControlUI feature1 = new UserAirConditionerControlUI();
					tabbedPane.addTab("User Air Conditioner Control", null, feature1);
				}
			}
			if(feature instanceof AutomatedAirConditionerControl){
				...
				if(!alreadyExist){
					AutomatedAirConditionerControlUI feature2 = new AutomatedAirConditionerControlUI();
					tabbedPane.addTab("Automated Air Conditioner Control", null, feature2);
				}
			}
			if(feature instanceof PresenceIlusion){
				...
				if(!alreadyExist){
					PresenceIlusionUI feature3 = new PresenceIlusionUI();
					tabbedPane.addTab("Presence Ilusion", null, feature3);
				}
			}
			if(feature instanceof AutomatedIluminationByPresence){
				...
				if(!alreadyExist){
					AutomatedIluminationByPresenceUI feature4 = new AutomatedIluminationByPresenceUI();
					tabbedPane.addTab("Automated Ilumination By Presence", null, feature4);
				}
			}
			if(feature instanceof UserIlumination){
				...
				if(!alreadyExist){
					UserIluminationUI feature5 = new UserIluminationUI();
					tabbedPane.addTab("User Ilumination", null, feature5);
				}
			}
			if(feature instanceof AutomatedIluminationByLuminosity){
				...
				if(!alreadyExist){
					AutomatedIluminationByLuminosityUI feature6 = new AutomatedIluminationByLuminosityUI();
					tabbedPane.addTab("Automated Ilumination By Luminosity", null, feature6);
				}
			}
			if(feature instanceof UserWindowControl){
				...
				if(!alreadyExist){
					UserWindowControlUI feature7 = new UserWindowControlUI();
					tabbedPane.addTab("User Window Control", null, feature7);
				}
			}
			if(feature instanceof AutomatedWindowControl){
				...
				if(!alreadyExist){
					AutomatedWindowControlUI feature8 = new AutomatedWindowControlUI();
					tabbedPane.addTab("Automated Window Control", null, feature8);
				}
			}
			if(feature instanceof PanicMode){
				...
				if(!alreadyExist){
					PanicModeUI feature9 = new PanicModeUI();
					tabbedPane.addTab("Panic Mode", null, feature9);
				}
			}
			if(feature instanceof AlarmAgainstRobbery){
				...
				if(!alreadyExist){
					AlarmAgainstRobberyUI feature10 = new AlarmAgainstRobberyUI();
					tabbedPane.addTab("Alarm Against Robbery", null, feature10);
				}
			}
			if(feature instanceof LockDoors){
				...
				if(!alreadyExist){
					LockDoorsUI feature11 = new LockDoorsUI();
					tabbedPane.addTab("Lock Doors", null, feature11);
				}
			}
